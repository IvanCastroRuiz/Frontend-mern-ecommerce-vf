...
const AsideVenta = ({ verAside, setAsideVentas }) => {
  ...
  return (
    <div div className={`${verAside ? ' absolute top-20 right-0 bg-slate-200 p-4 overflow-auto z-10 w-full md:w-3/4 lg:w-2/3 mb-96 flex flex-col justify-between h-[37rem]' : 'hidden'}`}>
      <div className='overflow-y-scroll mb-3'>
        ...
        <div className='my-5 '>
          ...
          <p className='w-full text-center font-bold text-xl  mt-2 uppercase text-sky-700 flex justify-between px-4'> <i>SubTotal : </i> <span className='font-medium text-black'>$ {precioTotal}</span></p>
        </div>
      </div>
