          ...
          <div className="mx-auto sm:px-2 sm:w-2/3 mt-8 shadow-md border-2 h-3/4">
            <div className='my-5 flex flex-col items-center md:flex-row md:items-start gap-4 '>
              ...
              <div className='w-full md:w-1/3 md:h-[37rem] flex flex-col justify-between '>
                <div>
                  <p className=' w-full text-center font-bold text-xl block mt-2 uppercase text-sky-700'> <i>Total Productos :  </i> <span className='font-medium block text-black'>{venta.length}</span></p>
                  <p className='  w-full text-center font-bold text-xl block mt-2 uppercase text-sky-700'> <i>Precio total de lista :  </i> <span className='font-medium block text-black'>$ {precioTotal}</span></p>
                </div>
                <button className="bg-sky-700 text-white rounded-lg uppercase font-medium hover:bg-sky-500 transition-colors p-2">
                  enviar
                </button>
              </div>
            </div>
